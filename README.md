...
| [`nre`](./skills/nre/SKILL.md) | `skills/nre/` | NRE `release_26.04` (`nvcr.io/nvidia/nre/{nre,nre-tools}`) | Train 3DGUT/3DGRT Gaussian reconstructions, perform carline adaptation with augmented target rigs, render novel views (local or via gRPC), export PLY/mesh/depth, edit actors, evaluate quality. |
